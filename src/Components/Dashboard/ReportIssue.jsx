  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (selectedImage && selectedImage.file) {
        ...
        const uploadResponse = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/complains/upload-image`, {
          method: 'POST',
          headers: {
      ...
      const response = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/complains/create`, {
        method: 'POST',
        headers: {
